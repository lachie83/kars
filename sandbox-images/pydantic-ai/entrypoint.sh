...
python3 -c "from kars_runtime_pydantic_ai.runtime import bootstrap; bootstrap()"
...
if [ ! -f /sandbox/agent/main.py ]; then
    echo "[kars-pydantic-ai] no /sandbox/agent/main.py — running bundled default agent" >&2
