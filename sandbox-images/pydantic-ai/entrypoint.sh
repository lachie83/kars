...
python3 -c "from azureclaw_runtime_pydantic_ai.runtime import bootstrap; bootstrap()"
...
if [ ! -f /sandbox/agent/main.py ]; then
    echo "[azureclaw-pydantic-ai] no /sandbox/agent/main.py — running bundled default agent" >&2
