...
python3 -c "from azureclaw_runtime_anthropic.runtime import bootstrap; bootstrap()"
...
if [ ! -f /sandbox/agent/main.py ]; then
    echo "[azureclaw-anthropic] no /sandbox/agent/main.py — running bundled default agent" >&2
