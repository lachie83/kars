...
| `foundry_evaluations` | Run agent-quality evaluations (used by `KarsEval` reconciler). |
...
| `foundry-evaluations` | `foundry_evaluations` | Eval setup; verdict interpretation; integration with `KarsEval` CRD. |
